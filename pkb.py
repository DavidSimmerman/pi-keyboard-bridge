...
if platform.system() == "Linux": print(platform.system())
...
class KeyClass():
    ...
    def sendKeys(self):
        print(list(self.keysDown))

    def pressKey(self, key):
        if key in self.keysDown: return
...
with Listener(on_press=KeyObj.pressKey, on_release=KeyObj.liftKey) as listener:
    listener.join()
